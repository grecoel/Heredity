...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # Determine whether the person has the trait
        has_trait = person in have_trait

        # If person has no parental info, use unconditional probability
        if mother is None and father is None:
            gene_prob = PROBS["gene"][genes]
        else:
            # Parent gene transmission probabilities
            ...
            mom_pass = pass_gene(mother)
            dad_pass = pass_gene(father)
...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    for person in probabilities:
        ...
        # Update the appropriate gene and trait values
